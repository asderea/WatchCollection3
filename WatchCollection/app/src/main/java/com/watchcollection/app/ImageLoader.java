...
public final class ImageLoader {
    ...
    public static String importUri(Context context, Uri uri) throws Exception {
        return importToFolder(context, uri, "strap_images", "strap");
    }

    public static String importWatchUri(Context context, Uri uri) throws Exception {
        return importToFolder(context, uri, "watch_images_manual", "watch");
    }

    private static String importToFolder(Context context, Uri uri, String folder, String prefix) throws Exception {
        File dir = new File(context.getFilesDir(), folder);
        dir.mkdirs();
        String name = String.format(Locale.ROOT, "%s_%d.jpg", prefix, System.currentTimeMillis());
