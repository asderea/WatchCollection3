...
public class MainActivity extends Activity {
    ...
    private View rateOverviewGraph(List<Watch> watches) {
        ...
        card.addView(UiKit.muted(this,"각 시계마다 그래프 폭을 넓게 사용합니다. 가운데 기준선이 0 s/day이고, 막대 길이는 전체 시계 중 가장 큰 |Rate|를 기준으로 상대 표시합니다.",10));
        card.addView(UiKit.spacer(this,8));
        ...
        for(Watch w:watches) {
            ...
            LinearLayout.LayoutParams plotLp=new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,UiKit.dp(this,34));
            ...
            plot.post(() -> {
                ...
                FrameLayout.LayoutParams zlp=new FrameLayout.LayoutParams(UiKit.dp(this,1),UiKit.dp(this,28));
                ...
                if(!Double.isNaN(rateValue)) {
                    ...
                    FrameLayout.LayoutParams blp=new FrameLayout.LayoutParams(barWidth,UiKit.dp(this,10));
